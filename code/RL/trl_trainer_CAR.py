...
from CARUtils import compute_reward, CONV_DELIMITER
import CARConfig as carconfig
import nltk
import numpy as np
...
nltk.download("punkt")
model_id=carconfig.init_model_path
max_source_length=carconfig.max_source_length
max_target_length=carconfig.max_target_length
outdir=carconfig.model_out_dir

dataset = load_dataset('csv', data_files={'train': carconfig.train_data_file})
