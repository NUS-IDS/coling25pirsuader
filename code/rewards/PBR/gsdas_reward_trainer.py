...
#    dataset_name: Optional[str] = field(default="Anthropic/hh-rlhf", metadata={"help": "the model name"})
    ...
    output_dir: Optional[str] = field(default="/tmp/pbr_reward_model", metadata={"help": "the output directory"})
...
dataset_name="../../../data/forrl/train_pbr_data.csv"
...
train_dataset = load_dataset('csv', data_files={'train': dataset_name})['train']
